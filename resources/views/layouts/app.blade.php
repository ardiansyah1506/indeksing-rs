    ...
    <script>
        function toggleDropdown() {
            ...
            if (dropdown.classList.contains("show")) {
                icon.innerHTML = "▲"; // Icon up
            } else {
                icon.innerHTML = "▼"; // Icon down
            }
        }
    </script>
</head>
<body class="flex m-0 p-0 font-sans bg-gray-100">
    <!-- Sidebar -->
    <div class="sidebar w-64 min-h-screen flex flex-col justify-between bg-sidebar p-5 fixed left-0 top-0 overflow-y-auto shadow-md z-10">
     <div>
        ...
        <nav class="w-64 bg-white shadow-sm rounded-lg p-4 overflow-hidden">
            <ul class="list-none p-0 space-y-2">
                ...
                <!-- Indeks Rawat Jalan -->
                <li class="rounded-md transition-colors @if(request()->routeIs('indeks-rajal')) bg-blue-100 text-blue-700 font-medium @endif hover:bg-blue-50">
                    <a href="{{ route('indeksing.index') }}" class="flex items-center gap-3 p-3 text-gray-700 hover:text-blue-700">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
               ...
               <ul id="laporan-dropdown" class="hidden transition-all duration-200 list-none pl-10 pr-2 py-1 space-y-1">
                ...
                <li class="rounded-md transition-colors hover:bg-blue-50">
                    <div class="flex items-center justify-between p-3 text-gray-700 cursor-pointer hover:text-blue-700" data-collapse-toggle='settings-dropdown'>
                        ...
                        <svg id="settings-icon" class="w-4 h-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </div>
                    <ul id="settings-dropdown" class="hidden transition-all duration-200 list-none pl-10 pr-2 py-1 space-y-1">
                        <li class="rounded-md p-2 hover:bg-blue-50 @if(request()->routeIs('laporan.penyakit')) bg-blue-100 text-blue-700 @endif">
                            <a href="{{ route('poli.index') }}" class="flex items-center gap-2 text-gray-700 hover:text-blue-700">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="rounded-md p-2 hover:bg-blue-50 @if(request()->routeIs('laporan.dokter')) bg-blue-100 text-blue-700 @endif">
                            <a href="{{ route('dokter.index') }}" class="flex items-center gap-2 text-gray-700 hover:text-blue-700">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                </svg>
                        ...
                        <li class="rounded-md p-2 hover:bg-blue-50 @if(request()->routeIs('laporan.tindakan')) bg-blue-100 text-blue-700 @endif">
                            <a href="{{ Route('icd10_primary.index') }}" class="flex items-center gap-2 text-gray-700 hover:text-blue-700">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                        ...
                        <li class="rounded-md p-2 hover:bg-blue-50 @if(request()->routeIs('laporan.kematian')) bg-blue-100 text-blue-700 @endif">
                            <a href="{{ Route('icd10_secondary.index') }}" class="flex items-center gap-2 text-gray-700 hover:text-blue-700">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                        ...
                        <li class="rounded-md p-2 hover:bg-blue-50 @if(request()->routeIs('laporan.kematian')) bg-blue-100 text-blue-700 @endif">
                            <a href="{{ route('icd9.index') }}" class="flex items-center gap-2 text-gray-700 hover:text-blue-700">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                                <span>Icd9</span>
        ...
        <div class="mt-8">
                <a href="{{ route('logout') }}" type="submit" class="w-full flex items-center justify-center gap-2 bg-gray-500 text-white p-2.5 rounded cursor-pointer hover:bg-gray-600 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
