...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Data Poliklinik</h1>
    ...
    <div x-data="{ editMode: false, editData: { id: '', nama: ''} }">
        ...
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 x-text="editMode ? 'Edit Data Poliklinik' : 'Tambah Data Poliklinik'" class="text-xl font-semibold mb-4"></h2>

            <form :action="editMode ? `/poli/${editData.id}` : '{{ route('poli.store') }}'" method="POST" class="space-y-4">
                @csrf
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        ...
                        <form action="{{ route('poli.destroy', $item->id) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
